...
--------------------------------------------------------------
INSERT INTO Maps (File, Domain, Name, Description, Image)
VALUES 
	/* standard maps */
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEPEarth.lua', 'StandardMaps', 'LOC_MAP_AEP_EARTH_NAME', 'LOC_MAP_AEP_EARTH_DESCRIPTION', NULL),
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEPEarth_Top.lua', 'StandardMaps', 'LOC_MAP_AEP_EARTH_TOP_NAME', 'LOC_MAP_AEP_EARTH_TOP_DESCRIPTION', NULL),
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEPEarth_Bottom.lua', 'StandardMaps', 'LOC_MAP_AEP_EARTH_BOTTOM_NAME', 'LOC_MAP_AEP_EARTH_BOTTOM_DESCRIPTION', NULL),
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEP_NewWorld.lua', 'StandardMaps', 'LOC_MAP_AEP_NEW_WORLD_NAME', 'LOC_MAP_AEP_NEW_WORLD_DESCRIPTION', NULL),
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEP_Oceania.lua', 'StandardMaps', 'LOC_MAP_AEP_OCEANIA_NAME', 'LOC_MAP_AEP_OCEANIA_DESCRIPTION', NULL),
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEP_AncientWorld.lua', 'StandardMaps', 'LOC_MAP_AEP_ANCIENT_WORLD_NAME', 'LOC_MAP_AEP_ANCIENT_WORLD_DESCRIPTION', NULL),

	/* GS maps */
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEP_Oceania_XP2.lua', 'Maps:Expansion2Maps', 'LOC_MAP_AEP_OCEANIA_NAME', 'LOC_MAP_AEP_OCEANIA_DESCRIPTION', NULL),
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEP_NewWorld_XP2.lua', 'Maps:Expansion2Maps', 'LOC_MAP_AEP_NEW_WORLD_NAME', 'LOC_MAP_AEP_NEW_WORLD_DESCRIPTION', NULL),
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEP_AncientWorld_XP2.lua', 'Maps:Expansion2Maps', 'LOC_MAP_AEP_ANCIENT_WORLD_NAME', 'LOC_MAP_AEP_ANCIENT_WORLD_DESCRIPTION', NULL),
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEPEarth_Bottom_XP2.lua', 'Maps:Expansion2Maps', 'LOC_MAP_AEP_EARTH_BOTTOM_NAME', 'LOC_MAP_AEP_EARTH_BOTTOM_DESCRIPTION', NULL),
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEPEarth_Top_XP2.lua', 'Maps:Expansion2Maps', 'LOC_MAP_AEP_EARTH_TOP_NAME', 'LOC_MAP_AEP_EARTH_TOP_DESCRIPTION', NULL),
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/AEPEarth_XP2.lua', 'Maps:Expansion2Maps', 'LOC_MAP_AEP_EARTH_NAME', 'LOC_MAP_AEP_EARTH_DESCRIPTION', NULL),

	/* TSL GS maps */
	('{0D260DE6-56DC-4704-9486-1E532E1432BD}Maps/TSL_AEP_Oceania_XP2.lua', 'Maps:Expansion2Maps', 'LOC_MAP_TSL_AEP_OCEANIA_NAME', 'LOC_MAP_TSL_AEP_OCEANIA_DESCRIPTION', 'Map_TrueStartEarth');
